...
{$R 'php4Delphi.TWinForm.resources' 'php4Delphi.MainForm.resx'}
...
uses
  ...
  php4Delphi.MainForm in 'php4Delphi.MainForm.pas' {php4Delphi.MainForm.TWinForm: System.Windows.Forms.Form},
  php4Delphi.Standard in 'php4Delphi.Standard.pas';
